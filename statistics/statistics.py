...
@LastEditTime: 2020-05-25 18:13:44
...
class PrePeriodStatistics():
    def __init__(self):
        pass

    def transform(self, x, groupby_cols, op_cols, period_col=['day'], pre_preiod=1, op_mapper=None):
...
class CrossStatistics():
    ...
    def transform(self, cross_cols, ops=['nunique', 'entropy', 'count', 'count_ratio']):
